...
export function AppShowcase() {
  ...
  return (
    <div className="flex aspect-[3/4] w-full select-none flex-col overflow-hidden rounded-2xl border border-[#2f2226] bg-[#160f10] text-[11px] sm:aspect-[15/8] sm:text-xs">
